...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="pb-7 pt-7">
      <div className="container my-5">
        <div className="row justify-content-center">
          <div className="col-lg-12">
            <div className="row contact-wrapper mx-2">
              <div className="col-md-6 contact-left d-flex flex-column justify-content-between">
                <div>
                  <h1 className="text-black" {...cp('contactConfig.title')}>{t(contact.title)}</h1>
                  <p {...cp('contactConfig.description')}>{t(contact.description)}</p>
                </div>
                <div>
                  <div className="info-card d-flex align-items-start">
                    <div className="p-1 me-4" style={{ border: '1px solid black', borderRadius: 50 }}>
                    ...
                    <div>
                      ...
                      <br />
                      <a href={`mailto:${contact.email}`} className="text-decoration-none text-black" {...cp('contactConfig.email')}>
                        {contact.email}
                      </a>
                    </div>
                  </div>
                  <div className="info-card d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <br />
                      <a href={`tel:${contact.phone}`} className="text-black text-decoration-none" {...cp('contactConfig.phoneDisplay')}>
